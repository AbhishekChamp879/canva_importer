...
The service uses a local Flask server with debug and reloader disabled. Credentials stay in the backend. The four Python dependencies support capture, HTTP serving, image processing, and request validation.
